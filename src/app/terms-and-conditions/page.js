const page = () => {
  return (
    <div className="p-[2rem]">
      ...
      <p>Welcome to Arogya Drishti!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Arogya Drishtit&apos;s Website, located at flextransformation.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Arogya Drishti if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing Arogya Drishti, you agreed to
        use cookies in agreement with the Arogya Drishti&apos;s Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, Arogya Drishti and/or its licensors own the
        intellectual property rights for all material on Arogya Drishti. All
        intellectual property rights are reserved. You may access this from
        Arogya Drishti for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Arogya Drishti</li>
        <li>Sell, rent or sub-license material from Arogya Drishti</li>
        <li>Reproduce, duplicate or copy material from Arogya Drishti</li>
        <li>Redistribute content from Arogya Drishti</li>
      </ul>
      ...
      <p>
        ...
        Arogya Drishti does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of Arogya Drishti,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Arogya Drishti
      ...
      <p>
        Arogya Drishti reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Arogya Drishti a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Arogya Drishti; and (d) the
      ...
      <p>
        ...
        e-mail to Arogya Drishti. Please include your name, your organization
      ...
      <p>
        No use of Arogya Drishti&apos;s logo or other artwork will be allowed
